...
function printHello() {
    ...
    let a = 20; // This a is different from the global a, it is function scoped to printHello.
    console.log( "Inside printHello: " + a ); // Output: 20
    if ( true ) {
        let a = 30; // This will overwrite the previous a declared inside the function, but it will not affect the global a.
