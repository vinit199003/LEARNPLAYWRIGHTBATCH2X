// Confusing comparison cases for == and === in JavaScript.
// Use === when you want both value and type to match.
...
console.log( 'null == undefined:', null == undefined ); // true: special loose-equality rule
console.log( '[] == false:', [] == false ); // true: [] becomes "" then 0
console.log( '[1] == 1:', [ 1 ] == 1 ); // true: [1] becomes "1" then 1
console.log( 'NaN == NaN:', NaN == NaN ); // false: NaN never equals NaN

console.log( '--- Strict equality (===) ---' );
console.log( '0 === false:', 0 === false ); // false: different types
console.log( '1 === true:', 1 === true ); // false: different types
console.log( '"1" === 1:', '1' === 1 ); // false: string vs number
